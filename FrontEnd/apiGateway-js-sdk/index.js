...
var apigClient = apigClientFactory.newClient({
    apiKey : 'v2TOYLMwvY9jrOvERPcS41jeoGwYb7F82VuQRNdA'
});
...
function uploadPhoto() {
    ...
    var encoded_image = getBase64(file).then((data) => {
      ...
      url = "https://vs6p15w162.execute-api.us-east-1.amazonaws.com/dev/upload/index-photos-b2/" + file.name
